...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>My Student's Attendance : <span style="color:blue;">{{ $getStudent->name }} {{ $getStudent->last_name }} (Total: {{ $getRecord->total() }})</span>  </h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
    <div class="card">
        <div class="card-header">
          <h3 class="card-title">Search My Student's Attendance</h3>
        </div>
            ...
            <div class="card-body">
              ...
              <div class="form-group col-md-2">
                ...
                <select name="class_id"  class="form-control" >
                    ...
                    <option {{ (Request::get('class_id')==$class->class_id) ? 'selected' :'' }} required value="{{ $class->class_id }}">{{ $class->class_name }}</option>
              ...
              <div class="form-group col-md-2" style="margin-top: 10px;min-width:300px;">
                ...
                <a href="{{ url('parent/my_student_attendance/'.$getStudent->id) }}" class="btn btn-danger" style="margin-top: 20px;">Clear</a>
              </div>
            </div>
            </div>
            <!-- /.card-body -->
