...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1>Submitted HomeWork <span style="color: blue;">{{ $getStudent->name }} {{$getStudent->last_name  }}</h1>
          </div>
                ...
                <form method="get" action="">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Class" name="class_name"  value="{{ Request::get('class_name') }}">
                      ...
                      <div class="form-group col-md-3" style="margin-top: 10px;">
                        ...
                        <a href="{{ url('parent/my_student_submitted_homework/'.$getStudent->id) }}" class="btn btn-danger" style="margin-top: 20px;">Reset</a>
                      </div>
