         ...
         <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                ...
                <a class="btn btn-primary btn-sm" style="float: right;" target="_blank" href="{{ url('print/my_Exam_result/print?exam_id='.$value['exam_id'].
                '&student_id='.Auth::user()->id )}}">Print</a>
              </div>
