            ...
            <form method="get" action="">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Subject Name" name="name" value="{{ Request::get('name') }}">
                  ...
                  <tbody>
                    ...
                    <tr>
                       ...
                       <td>
                        ...
                        <td>
                            <a href="{{ url('admin/subject/edit/'.$class->id) }}" class="btn btn-primary">Edit</a>
                            <a href="{{ url('admin/subject/delete/'.$class->id) }}" class="btn btn-danger">Delete</a>
                        </td>
                    </tr>
