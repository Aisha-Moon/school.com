            ...
            <form method="get" action="">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group col-md-3" style="margin-top: 10px;">
                    ...
                    <a href="{{ url('admin/examinations/exam/list') }}" class="btn btn-danger" style="margin-top: 20px;">Clear</a>
                  </div>
                ...
                <table class="table table-striped">
                  ...
                  @foreach ($getRecord as $user)
                    <tr>
                        ...
                        <td>
                            <a href="{{ url('admin/examinations/exam/edit/'.$user->id) }}" class="btn btn-primary">Edit</a>
