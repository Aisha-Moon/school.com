                ...
                <form method="get" action="">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group col-md-3" style="margin-top: 10px;">
                        ...
                        <a href="{{ url('admin/homework/homework') }}" class="btn btn-danger" style="margin-top: 20px;">Reset</a>
                      </div>
                  ...
                  <thead>
                   ...
                   <tr>
                    ...
                    <td style="min-width:300px;">
                        ...
                        <a href="{{ url('admin/homework/homework/submitted/'.$value->id) }}" class="btn btn-success">Submitted H.W</a>
                    </td>
                   </tr>
                    @empty
