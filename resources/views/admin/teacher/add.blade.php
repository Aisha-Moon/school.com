                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" required id="last_name" required placeholder="Enter Last Name" name="last_name" value="{{ old('last_name') }}">
                     ...
                     <div class="form-group col-md-6">
                        ...
                        <input required type="date" class="form-control" id="date_of_joining"  name="admission_date" value="{{ old('admission_date') }}">
                     ...
                     <div class="form-group col-md-6">
                        ...
                        <input type="text" required class="form-control" id="mobile_number" placeholder="Mobile Number" name="mobile_number" value="{{ old('mobile_number') }}">
                        <div style="color:red;">{{ $errors->first('mobile_number') }}</div>

                     </div>
                     <div class="form-group col-md-6">
                        <label for="marital_status">Marital Status <span style="color: red;"></span> </label>
                        <input type="text" class="form-control" id="marital_status" placeholder="Marital Status" name="marital_status" value="{{ old('marital_status') }}">
                     ...
                     <div class="form-group col-md-6">
                        ...
                        <textarea name="address" required class="form-control" id="address"  >{{ old('address') }}</textarea>
                     ...
                     <div class="form-group col-md-6">
                        ...
                        <textarea name="qualification" class="form-control" id="qualification"  >{{ old('qualification') }}</textarea>
                        <div style="color:red;">{{ $errors->first('qualification') }}</div>

                     </div>
                     <div class="form-group col-md-6">
                        <label for="work_experience">Work Experience<span style="color: red;"></span> </label>
                        <textarea name="work_experience" class="form-control" id="work_experience"  >{{ old('work_experience') }}</textarea>
