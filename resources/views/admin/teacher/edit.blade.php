                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-6">
                     ...
                     <div class="form-group col-md-6">
                        ...
                        <input required type="date" class="form-control" id="date_of_joining"  name="admission_date" value="{{ old('admission_date',$getRecord->admission_date) }}">
                     ...
                     <div class="form-group col-md-6">
                        ...
                        <textarea name="note" id="note" class="form-control" >{{ old('note',$getRecord->note) }}</textarea>
